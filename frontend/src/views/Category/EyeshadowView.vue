...
export default {
  ...
  //     try {
  //       return products.value.filter(product => product.brandName === brandName.value && product.productCategory === 'Eyeshadow');
  //     } catch (error) {
  ...
  computed: {
    filteredCategory() {
      return this.products.filter(product => product.brandName === this.brandName && product.productCategory === 'Eyeshadow')
    }
  },
